...
let ProfileController = class ProfileController {
    ...
    getProfile(id, req) {
        return this.profileService.getProfile(id, req.user.userId, req.user.is_staff);
    }
    ...
    async completeResearcherProfile(id, dto) {
...
__decorate([
    ...
    __param(2, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, profile_dto_1.ChangePasswordDto, Object]),
    __metadata("design:returntype", void 0)
], ProfileController.prototype, "changePassword", null);
__decorate([
    (0, common_1.Patch)(':id/complete-researcher'),
    (0, common_1.UseGuards)(),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, profile_dto_1.UpdateResearcherProfileDto]),
    __metadata("design:returntype", Promise)
], ProfileController.prototype, "completeResearcherProfile", null);
